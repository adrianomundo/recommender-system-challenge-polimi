from recommenders import UserCFKNNRecommender, TopPopRecommender


class UserCFKNNTopPopHybrid(object):

    def __init__(self):
        self.cf_recommender = UserCFKNNRecommender.UserCFKNNRecommender()
