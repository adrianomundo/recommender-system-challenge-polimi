...
class Hybrid(object):
    ...
    def __init__(self, item_cf_weight=1.056, item_cbf_weight=2.069, user_cf_weight=0.03977,
                 elastic_weight=0.542, rp3_weight=1.404, slim_weight=5):
    ...
    def fit(self, urm_train, warm_users, icm_all, ucm_all):
        ...
        self.slim_recommender.fit(urm_train, load_matrix=True)
